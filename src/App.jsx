...
import {
  Calendar, Clock, Link as LinkIcon, Share2, Upload, Download,
  Search, ChevronLeft, ExternalLink, Globe, Info
} from "lucide-react";
...
function parseHash() { return parseHashFromString(window.location.hash); }
...
function TestPanel() {
  ...
  results.push(test("parseHashFromString issue", () =>
...
function test(name, fn) {
  try { const r = fn(); return { name, ok: !!r, msg: r ? "" : "returned falsy" }; }
  catch (e) { return { name, ok: false, msg: e?.message || String(e) }; }
}
